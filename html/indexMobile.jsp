...
<script>
	...
	function sendPtz(elem, cmdStart, cmdStop)
	{
	  if (lastElemText != "" && lastElem != elem)
	  {
	    lastElem.value = lastElemText;
	    lastElem.textContent = lastElemText;
	  }
	  
	  if ("Stop" == elem.value)
	  {
	    elem.value = lastElemText;
	    elem.textContent = lastElemText;
	    sendCmd(cmdStop);
	    lastElemText = "";
	  }
	  else
	  {
	    lastElemText = elem.textContent;
	    elem.value = "Stop";
		...
		<div class="col-xs-12" align="center">
			...
			<div class="row" style="align: center">
				...
				<div class="col-xs-3" align="center">
					<div class="row">
						<div class="col-xs-12">
							<button onclick="sendPtz(this, 'TILT_UP_START', 'PAN_TILT_STOP')"  type="button" class="btn btn-primary">Up</button>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4" align="center">
							<button onclick="sendPtz(this, 'PAN_LEFT_START', 'PAN_TILT_STOP')"  type="button" class="btn btn-primary">Left&nbsp</button>
						</div>
						<div class="col-xs-4" align="center">
						</div>
						<div class="col-xs-4" align="center">
							<button onclick="sendPtz(this, 'PAN_RIGHT_START', 'PAN_TILT_STOP')"  type="button" class="btn btn-primary">Right</button>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12" align="center">
							<button onclick="sendPtz(this, 'TILT_DOWN_START', 'PAN_TILT_STOP')"  type="button" class="btn btn-primary">Down</button>
						</div>
					</div>
				</div>
				<div class="col-xs-3" align="center">
					<div class="row">
						<div class="col-xs-12">
							<button onclick="sendPtz(this, 'ZOOM_WIDE_START', 'ZOOM_STOP')"  type="button" class="btn btn-primary">Zoom In</button>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12"></div>
					...
					<div class="row">
						<div class="col-xs-12">
							<button onclick="sendPtz(this, 'ZOOM_TELE_START', 'ZOOM_STOP')"  type="button" class="btn btn-primary">Zoom Out</button>
						</div>
					</div>
				</div>
				<div class="col-xs-3" align="center">
					<div class="row">
						<div class="col-xs-12">
							<button onclick="sendPtz(this, 'FOCUS_NEAR_START', 'FOCUS_STOP')"  type="button" class="btn btn-primary">Focus +</button>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							<button onclick="sendPtz(this, 'FOCUS_FAR_START', 'FOCUS_STOP')"  type="button" class="btn btn-primary">Focus -</button>
						</div>
					</div>
				</div>
			</div>
